        ...
        <div className="max-w-3xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="bg-white shadow-lg rounded-lg p-6 transform transition duration-300 hover:scale-105">
              ...
              <button className="w-full py-2 mt-4 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600 transition duration-300">
                Contact Us
              </button>
            </div>
            
            <div className="bg-blue-500 text-white shadow-lg rounded-lg p-6 transform transition duration-300 hover:scale-105">
              ...
              <button className="w-full py-2 mt-4 bg-white text-blue-500 font-semibold rounded-lg hover:bg-gray-200 transition duration-300">
                Contact Us
              </button>
            </div>
